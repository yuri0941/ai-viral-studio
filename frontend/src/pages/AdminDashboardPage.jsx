                ...
                {quickActions.map((action, i) => {
                    ...
                    return (
                        <button
                            ...
                            className={`group relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br ${action.gradient} border ${action.border} hover:border-[var(--border-strong)] transition-all hover:scale-[1.02] text-left`}
                        >
