...
export function TemplatesTab() {
    ...
    const copy = () => {
        // [VALUE-2026-08-04] added: guard against undefined generated text
        const text = result?.aiText || result?.text || 'Не удалось сгенерировать. Попробуйте ещё раз.'
    ...
    const schedule = () => {
        // [VALUE-2026-08-04] added: redirect with prefill to scheduler
