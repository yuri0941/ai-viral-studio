        ...
        <div className="space-y-6">
            ...
            <div className="rounded-2xl bg-white/[0.03] border border-[var(--border)] p-5">
                ...
                <div className="flex gap-3">
                    ...
                    <button onClick={handleCreate} className="px-4 py-2 rounded-xl bg-[#8b5cf6] hover:bg-[#7c3aed] text-[var(--text)] text-sm flex items-center gap-2"><Plus className="w-4 h-4" /> Создать</button>
                </div>
            </div>
                    ...
                    <div key={k._id} className="rounded-2xl bg-white/[0.03] border border-[var(--border)] p-5">
                        ...
                        <div className="border-t border-[var(--border)] pt-4">
                            ...
                            <div className="flex gap-2 mb-2">
                                ...
                                <button onClick={() => addWebhook(k._id)} className="px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-[var(--text)] text-xs">Добавить</button>
                            </div>
                            {k.webhooks?.map(w => (
