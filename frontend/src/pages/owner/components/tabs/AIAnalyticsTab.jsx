    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-semibold text-white">AI Аналитика</h2>
            </div>
            ...
            <div className="rounded-2xl bg-[#0f0f1a] border border-white/5 p-5">
                <h3 className="text-sm font-semibold text-white mb-4">Прогноз доходов (AI)</h3>
                <div className="space-y-3">
                    {aiAnalytics.revenueForecast.map((f, i) => (
                        <div key={i} className="space-y-1">
                            <div className="flex items-center justify-between text-xs">
                                <span className="text-white font-medium">{f.month}</span>
            ...
            <div className="rounded-2xl bg-[#0f0f1a] border border-white/5 p-5">
                <h3 className="text-sm font-semibold text-white mb-3">AI Рекомендации</h3>
                <div className="space-y-3">
                    {aiAnalytics.recommendations.map(rec => (
                        <div key={rec.id} className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
