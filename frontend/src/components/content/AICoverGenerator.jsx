                ...
                {result && (
                    <div className="space-y-3">
                        <div className="rounded-xl overflow-hidden border border-white/10 bg-[#0a0a0f]">
                            <img src={result.url} alt="cover" className="w-full h-auto object-contain max-h-[400px]" />
                        </div>
                        <div className="flex gap-2 flex-wrap">
                            ...
                            {onUse && (
                                <button onClick={() => { onUse(result); onClose() }} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-500/20 text-emerald-400 hover:bg-emerald-500/30 text-xs transition-colors">
