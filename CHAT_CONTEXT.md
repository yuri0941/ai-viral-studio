...
2. Ждать завершения 19.6 (K3 работает)
3. Прокликать по чек-листу из 19.6 (Шаг 9.3)
4. Запустить 19.2 → 19.4 → 19.7 → 19.9 → 19.10 (19.8 поглощён 19.14.4)
5. После каждого: скрин мобильной версии (375px) + скрин консоли
6. Только потом: 20-FACTORY-REAL
