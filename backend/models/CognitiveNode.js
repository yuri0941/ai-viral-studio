...
const cognitiveNodeSchema = new Schema({
  type: { type: String, enum: ['fact','skill','intent','emotion','decision','prediction','error','trend','project','client','telegram','action','system','content','longterm','support','research'], required: true },
