...
export const INITIAL_AI_ANALYTICS = {
    ...
    agents: [
        { id: 'pricing', name: 'Pricing Agent', role: 'Анализ цен', status: 'active', icon: 'TrendingUp', description: 'Анализирует цены конкурентов' },
        { id: 'revenue', name: 'Revenue Agent', role: 'Прогноз доходов', status: 'active', icon: 'BarChart3', description: 'Прогнозирует MRR' },
        { id: 'security', name: 'Security Agent', role: 'Мониторинг', status: 'active', icon: 'Shield', description: 'Отслеживает активность' },
        { id: 'growth', name: 'Growth Agent', role: 'Рекомендации', status: 'paused', icon: 'Zap', description: 'Анализирует рост' },
        { id: 'support', name: 'Support Agent', role: 'Авто-ответы', status: 'active', icon: 'MessageSquare', description: 'Отвечает на тикеты' },
        { id: 'content', name: 'Content Agent', role: 'Модерация', status: 'active', icon: 'Eye', description: 'Модерирует контент' },
    ],
}
