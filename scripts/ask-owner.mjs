...
//  - ИСКЛЮЧЕНИЕ: на вопросах ВЫБОРА владельца (дизайн/варианты, цены, публикации) таймаут-дефолта
//    НЕТ — вопрос ждёт ответа без срока; --default не передавать. Таймаут-дефолт — только на
//    технических мелочах.
