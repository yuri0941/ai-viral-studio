...
- Project Factory: 3 варианта, live preview, ZIP export, Telegram send (backend ready)
...
### Следующий этап: v9.9.19
- Neuro-Sales Dashboard v2, Predictive Engine UI, Voice Mode full (STT+TTS)
